...
　　}
	...
	function showRes(data){
		...
		var pophtml = '<div class="popup-tit">游戏结束</div>' +
					  '<div class="popup-cont">你打了 <i>' + data.total + '</i> 个僵尸，<br>战胜全宇宙 <i>' + data.percent + '%</i> 的小伙伴~<br>同时还获得了：<br><img src="images/gift01.png" alt=""><br><span class="gift-name">' + data.przCont +  '</span></div>' +
					  '<div class="popup-btn tc"><a href="javascript:;" class="btn-item"><img class="btn-showoff" src="images/show.png" alt="炫耀一下"></a><a href="javascript:;" class="btn-item"><img class="btn-view" src="images/view.png" alt="立即领取"></a></div>';
		setTimeout(function(){
