...
var Flyme = window.Flyme || {
	...
	shareSuccess: function(shareid, stype, openid){
		...
		window.wx && wx.ready(function(){
			...
			wx.onMenuShareTimeline({
			    ...
			    success: function (res) {
			    	Flyme.shareSuccess(settings.id, 1, settings.openid);
			    },
			    cancel: function (res) {
			    },
			    fail: function(res) {
			...
			wx.onMenuShareAppMessage({
			    ...
			    success: function (res) {
			    	Flyme.shareSuccess(settings.id, 2, settings.openid);
			    },
			    cancel: function (res) { 
			    },
			    fail: function(res) {
			...
			wx.onMenuShareQQ({
				...
				success: function(res) {
					Flyme.shareSuccess(settings.id, 3, settings.openid);
				},
				cancel: function(res) {
				},
				fail: function(res) {
			...
			wx.onMenuShareWeibo({
				...
				success: function(res) {
					Flyme.shareSuccess(settings.id, 4, settings.openid);
				},
				cancel: function(res) {
				},
				fail: function(res) {
